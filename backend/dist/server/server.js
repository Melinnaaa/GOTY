...
const releaseResources_1 = __importDefault(require("../tasks/releaseResources"));
...
class Server {
    ...
    routes() {
        ...
        this.app.use('/api/solicitud', solicitud_routes_1.default);
        this.app.use('/api/recurso', recurso_routes_1.default);
        this.app.use('/api/turno', turno_routes_1.default);
    }
    middlewares() {
        // CORS
